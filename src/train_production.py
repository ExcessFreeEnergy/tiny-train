...
def main():
    ...
    parser.add_argument("--dataset", type=str, choices=["tinystories", "fineweb", "fineweb-edu"], default=None, help="Dataset to train on (tinystories, fineweb, or fineweb-edu)")
    ...
    if dataset_name in ["fineweb-edu", "fineweb_edu"]:
