...
def main():
    ...
    parser.add_argument("--dataset", type=str, choices=["tinystories", "fineweb", "fineweb-edu", "cosmopedia", "cosmopedia-v2"], default=None, help="Dataset to train on")
    ...
    if dataset_name in ["cosmopedia-v2", "cosmopedia_v2", "cosmopedia"]:
